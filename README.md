...
The latest version allows you to create standalone filters in 32 and 64 bit! To make this possible, you must install **both** files (FilterFoundry.8bf and FilterFoundry64.8bf) in your Photoshop plugin directory.
